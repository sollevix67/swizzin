...
APT="nginx libnginx-mod-http-fancyindex subversion ssl-cert php8.3-fpm libfcgi0ldbl php8.3-cli php8.3-dev php8.3-xml php8.3-curl php8.3-xmlrpc php-json php8.3-mbstring php8.3-opcache php8.3-zip ${geoip} ${mcrypt}"
apt_install $APT
